            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        <th style="min-width: 120px">Featured</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$project->feat}}</span>

                        </td>
                        <td>
                            <span
                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$project->description}}</span>
                        </td>
                        <td>
                            <span class="label label-lg label-light-success label-inline">{{$project->status}}</span>
                        </td>
